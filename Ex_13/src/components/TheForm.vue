<template>
  <form @submit.prevent="submitForm">
    <div class="form-control">
      ...
      <p v-if="userNameValid === 'invalid'" style="color: red;">Please enter user name</p>
    </div>
    <div class="form-control">
    ...
    <div class="form-control">
      <input type="checkbox" name="confirm-term" id="confirm-term" v-model="confirm">
      <label for="confirm-term">Agree to term of use ?</label>
    </div>
    <div>
